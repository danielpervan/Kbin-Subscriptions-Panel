(() => {
  ...
  var require_src = __commonJS({
    "src/index.js"() {
      ...
      var subscriptionsPanel = new SubscriptionsPanel_default();
      var settingsModal = new SettingsModal_default(subscriptionsPanel);
      var onboardingModal = new OnboardingModal_default(settingsModal);
